...
[Installing Slack on Linux](https://linuxize.com/post/how-to-install-slack-on-ubuntu-20-04/)
...
- Security Control Frameworks
    ...
    - [ISACA - COBIT](https://www.isaca.org/resources/cobit) is used not only to plan the IT security of an organization but also as a guideline for auditors. COBIT is a widely recognized and respected security control framework.
...
- Honeypots & Tarpits
    - What is a Honepot? [imperva](https://www.imperva.com/learn/application-security/honeypot-honeynet/#:~:text=A%20honeypot%20is%20a%20security,to%20improve%20your%20security%20policies.)
    - What is a honeypot and how does it work? [norton](https://us.norton.com/blog/iot/what-is-a-honeypot)
    - What is a honeypot? [TechTarget](https://www.techtarget.com/searchsecurity/definition/honey-pot)
    - Honeypots [Bing](https://www.google.com/search?q=honepots&sca_esv=591053097&source=hp&ei=SbV7ZajnHqTIkPIP0Ne10As&iflsig=AO6bgOgAAAAAZXvDWdfPTEJUHF9o3ZYIVoAJ48ghpCih&ved=0ahUKEwjor-OXrpCDAxUkJEQIHdBrDboQ4dUDCAw&uact=5&oq=honepots&gs_lp=Egdnd3Mtd2l6Ighob25lcG90czIHEAAYgAQYCjIHEAAYgAQYCjIHEAAYgAQYCjIHEAAYgAQYCjIHEAAYgAQYCjIHEC4YgAQYCjIHEAAYgAQYCjIHEAAYgAQYCjIHEAAYgAQYCjIHEAAYgAQYCkj4KVCxCFiGH3ABeACQAQCYAfIBoAGfC6oBBTAuNy4xuAEDyAEA-&sclient=gws-wiz)
    - Tar Pits [Bing](https://www.google.com/search?sca_esv=591053097&q=cyber+security+tar+pits&spell=1&sa=X&ved=2ahUKEwj4s5OKr5CDAxXTTjABHWqGBp8QBSgAegQIBhAC&biw=960&bih=461&dpr=2)
- Other Resources
    - [hak5 usb-rubber-ducky](https://shop.hak5.org/products/usb-rubber-ducky)
    - Atom Computing is the first to announce a 1,000+ qubit quantum computer [Ars Technica](https://arstechnica.com/science/2023/10/atom-computing-is-the-first-to-announce-a-1000-qubit-quantum-computer/)
...
- Linux Distributions
    ...
    - Choose Your Kali [Download](https://www.kali.org/get-kali/#kali-platforms)
    - VMWare Workstation Player [Download](https://www.vmware.com/in/products/workstation-player/workstation-player-evaluation.html)
- Guacamole Setup
    - 2FAS - the Internet's favorite open-source authenticator [2fas](https://2fas.com/)
    - Guacamole Web VM: [Portal](https://cybersecurity.vmportal.org/)
    - Guacamole Web VM - Control Panel: [Control Panel](https://control.vmportal.org/)
